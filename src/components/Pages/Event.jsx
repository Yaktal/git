...
const Event = ({search}) => {
  ...
  return (
    ...
    <div className="justify-center flex-col flex">
      ...
      <h1 className="text-4xl mt-10 font-bold flex justify-center">Events & Festivals</h1>
      ...
      <div className="flex  justify-center flex-col ">
        ...
        <div className="flex justify-center">
          <div className="px-24 flex flex-col justify-center">
            ...
            <h1 className="font-bold text-3xl">Top 5 Events & Festivals in Jos</h1>
          <p className="">We've Curated a list of the top 5 Events & Festivals. Feel free to Explore.</p>
