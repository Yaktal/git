...
const Page = ({search}) => {
  ...
  return (
    ...
    <div className="mt-5">
      <img className="h-[20rem] w-[100%]" src="tour1.jpg" alt="" />
      ...
      <div className="p-10">
        ...
        <div className="flex flex-col font-semibold text-2xl space-y-4">
          <NavLink className="flex items-center hover:text-gray-700"><CIcon className="h-7 mr-2" icon={cilStar} size=""/>Broadway & Performing Arts <CIcon className="h-7 ml-2" icon={cilArrowRight} size=""/></NavLink>
          <NavLink className="flex items-center hover:text-gray-700"><CIcon className="h-7 mr-2" icon={cilHouse} size=""/>Museums & Galleries <CIcon className="h-7 ml-2" icon={cilArrowRight} size=""/></NavLink>
          <NavLink className="flex items-center hover:text-gray-700"><CIcon className="h-7 mr-2" icon={cilFlagAlt} size=""/>Tours & Attraction <CIcon className="h-7 ml-2 hover:text-gray-700" icon={cilArrowRight} size=""/></NavLink>
          <NavLink className="flex items-center hover:text-gray-700"><CIcon className="h-7 mr-2" icon={cilCalendar} size=""/>Events & Festivals <CIcon className="h-7 ml-2" icon={cilArrowRight} size=""/></NavLink>
          <NavLink className="flex items-center hover:text-gray-700"><CIcon className="h-7 mr-2" icon={cilBriefcase} size=""/>Shopping <CIcon className="h-7 ml-2" icon={cilArrowRight} size=""/></NavLink>
          <NavLink className="flex items-center hover:text-gray-700"><CIcon className="h-7 mr-2" icon={cilBasketball} size=""/>Sports <CIcon className="h-7 ml-2" icon={cilArrowRight} size=""/></NavLink>
          <NavLink className="flex items-center hover:text-gray-700"><CIcon className="h-7 mr-2" icon={cilDrinkAlcohol} size=""/>Nightlife <CIcon className="h-7 ml-2" icon={cilArrowRight} size=""/></NavLink>
          <NavLink className="flex items-center hover:text-gray-700"><CIcon className="h-7 mr-2" icon={cilHistory} size=""/>Founded By J City <CIcon className="h-7 ml-2" icon={cilArrowRight} size=""/></NavLink>
        </div>    
      </div>
    </div>
    ...
    <div className="flex justify-center flex-col mt-8">
        <img className="min-w-[30rem] mb-[3rem]" src="Dominoes.png" alt="" />
