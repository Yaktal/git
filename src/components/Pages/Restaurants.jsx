...
<div className="container mx-auto px-4 py-12">
    <div className="flex justify-between flex-col lg:flex-row">
        <div className="flex items-center gap-1 ml-4 text-3xl font-bold">
            <h1>RESTAURANTS</h1>
        </div>
          ...
          {cards
              ...
              <div className="p-4" key={item.id}>
                  ...
                  <div className="flex items-center justify-between mt-4">
                      <NavLink to="/restaurant-details" className="bg-green-200 text-green-600 b-green-500 px-2 py-[.4rem] lg:px-4 lg:py-2 rounded-lg hover:text-green-700 text-[.75rem] lg:text-[1rem]">More Info</NavLink>
                      <NavLink href="#" className="bg-green-700 text-white px-2 py-[.4rem] lg:px-4 lg:py-2 rounded-lg text-[.75rem] lg:text-[1rem]">Get Directions</NavLink>
                  </div>
                </div>
            </div>
        ))}
