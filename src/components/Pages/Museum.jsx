...
const Museum = ({search}) => {
  ...
  return (
    ...
    <div className="justify-center flex-col flex">
      ...
      <h1 className="text-4xl mt-10 font-bold flex justify-center">Museums & Galleries</h1>
      ...
      <div className="flex  justify-center flex-col ">
        ...
        <div className="flex justify-center">
          <div className="px-24 flex flex-col justify-center">
            ...
            <h1 className="font-bold text-3xl">Top 5 Museums & Galleries in Jos</h1>
          <p className="">We've Curated a list of the top 5 Museums & Galleries in Jos. Feel free to Explore.</p>
          <div className="mb-8 mt-3">
                <NavLink to='/topmuseum' className="flex items-center font-semibold hover:text-gray-700">LEARN MORE <CIcon className="h-7 ml-2" icon={cilArrowRight} size=""/></NavLink>
            </div>
          </div>
    ...
    <div className="App flex lg:justify-center space-x-4 p-4 lg:h-[30rem] items-center">
      <div className="img w-[23rem]">
        <ImgTransform
        imageUrl="/museum ta.jpeg"
        altText="Second Image"
        hoverText="Traditional Architecture"
      />
      </div>
      ...
      <div className="img w-[25rem] ">
        <ImgTransform
        imageUrl="/nt museum.jpeg"
        altText="Third Image"
        hoverText="National Museum"
      />
      </div>
