...
const InJos = ({search}) => {
  ...
  return (
    ...
    <div className="justify-center flex-col flex">
      ...
      <h1 className="text-4xl mt-10 font-bold flex justify-center">Founded In Jos</h1>
      ...
      <div className="flex  justify-center flex-col ">
        ...
        <div className="flex justify-center">
          <div className="px-24 flex flex-col justify-center">
            ...
            <h1 className="font-bold text-3xl">Museums & Galleries</h1>
          <p className="">J City is one of Nigeria's most diverse destinations. Explore the City's many cultural enclaves and see the many landmarks from every angle.</p>
          <div className="mb-8 mt-3">
                <NavLink to='/museum' className="flex items-center font-semibold hover:text-gray-700">LEARN MORE <CIcon className="h-7 ml-2" icon={cilArrowRight} size=""/></NavLink>
            </div>
          </div>
    ...
    <div className="mt-5">
      ...
      <div className="p-10">
        ...
        <div className="flex lg:flex-row flex-wrap justify-center flex-col font-semibold text-2xl space-y-4">
          ...
          <NavLink to="/wheretostay" className="pr-5 flex items-center hover:text-gray-700"><CIcon className="h-7 mr-2" icon={cilHouse} size=""/>Where To Stay<CIcon className="h-7 ml-2" icon={cilArrowRight} size=""/></NavLink>
