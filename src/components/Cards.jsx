  ...
  return (
    <div className=''>
      ...
      <div className="pt-[1.8rem] lg:pt-[5rem] pb-[1.5rem]">
        <NavLink to='/restaurant-details' className="cursor-pointer bg-green-600 px-6 py-2 text-white text-[.8rem] lg:text-[1rem] font-semibold rounded-md hover:bg-green-800">View Details</NavLink>
      </div>
